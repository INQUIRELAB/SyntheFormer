...
This project is licensed under the **INQUIRE Lab Academic Research License (Version 1.0)**, which permits noncommercial academic research use only. Commercial use requires prior written permission from the INQUIRE Lab. See `LICENSE` for details.
